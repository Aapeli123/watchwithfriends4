export namespace Response {
  ...
  export interface RoomDataResp {
    room: SrvrRoom;
  }
  export interface NewUserConnectedResp {
    user: [string, string];
  }
  export interface SetLeaderResp {
    success: boolean;
  }
  export interface SetVideoResp {
    success: boolean;
  }
  ...
  export interface UserChangedName {
    user_id: string;
    new_name: string;
  }
  ...
  export interface SrvrRoom {
    // Stands for ServerRoom to avoid confusion between this and the Room.tsx file export Room
    code: string;
